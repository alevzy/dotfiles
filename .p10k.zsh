# Generated by Powerlevel10k configuration wizard on 2026-02-19 at 21:14 MSK.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%246F─╮'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%246F─┤'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%246F─╯'
  ...
  function my_git_formatter() {
    ...
    local       meta='%223F' # white foreground
    local      clean='%235F' # black foreground
    local   modified='%235F' # black foreground
    local  untracked='%235F' # black foreground
